...
REM
REM Generated by Vivado on Sun Aug 16 13:16:48 -0400 2026
...
echo "xvhdl --incr --relax -prj vga_test_Shell_vhdl.prj"
call xvhdl  --incr --relax -prj vga_test_Shell_vhdl.prj -log xvhdl.log
