...
HD_PWD='O:/ENGS31/FPGA-Etch-A-Sketch/FPGA_Etch_A_Sketch/FPGA_Etch_A_Sketch/FPGA_Etch_A_Sketch.runs/frame_buffer_IP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frame_buffer_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frame_buffer_IP.tcl
