...
#
# Script generated by Vivado on Wed Aug 19 09:45:43 -0400 2026
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : frame_buffer_IP.sh
...
#
# Usage        : frame_buffer_IP.sh
#                frame_buffer_IP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                frame_buffer_IP.sh [-reset_run]
#                frame_buffer_IP.sh [-reset_log]
#                frame_buffer_IP.sh [-help]
#
...
# script info
echo -e "frame_buffer_IP.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./frame_buffer_IP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot frame_buffer_IP xil_defaultlib.frame_buffer_IP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim frame_buffer_IP -key {Behavioral:sim_1:Functional:frame_buffer_IP} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb frame_buffer_IP.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./frame_buffer_IP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: frame_buffer_IP.sh [-help]\n\
Usage: frame_buffer_IP.sh [-step]\n\
Usage: frame_buffer_IP.sh [-lib_map_path]\n\
Usage: frame_buffer_IP.sh [-reset_run]\n\
Usage: frame_buffer_IP.sh [-reset_log]\n\
Usage: frame_buffer_IP.sh [-keep_index]\n\
Usage: frame_buffer_IP.sh [-noclean_files]\n\n\
