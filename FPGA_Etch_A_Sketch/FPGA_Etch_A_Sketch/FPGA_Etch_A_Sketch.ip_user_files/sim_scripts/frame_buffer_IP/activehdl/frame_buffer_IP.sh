...
#                script (type 'frame_buffer_IP.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="O:/ENGS31/FPGA-Etch-A-Sketch/FPGA_Etch_A_Sketch/FPGA_Etch_A_Sketch/FPGA_Etch_A_Sketch.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
